"""
Loss functions adapted from:
Chen, X., Wang, C., Ning, H., Zhang, M., Shen, M., & Li, S. (2024). 
SAM-OCTA2: Layer Sequence OCTA Segmentation with Fine-tuned Segment Anything Model 2. 
arXiv preprint arXiv:2409.09286. https://arxiv.org/abs/2409.09286

BibTeX:
@misc{chen2024samocta2layersequenceocta,
      title={SAM-OCTA2: Layer Sequence OCTA Segmentation with Fine-tuned Segment Anything Model 2}, 
      author={Xinrun Chen and Chengliang Wang and Haojian Ning and Mengzhan Zhang and Mei Shen and Shiying Li},
      year={2024},
      eprint={2409.09286},
      archivePrefix={arXiv},
      primaryClass={cs.CV},
...
This file contains loss function implementations from the above paper and has been reused for educational and research purposes in a nuclei instance segmentation task.
"""
